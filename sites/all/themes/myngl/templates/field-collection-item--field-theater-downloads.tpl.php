...
?>
      ...
      <div class="social-icons">
          ...
          <script>function twt_click_<?php print $k; ?>() { window.open('https://twitter.com/share?url=<?php print ($u!= NULL)?urlencode($u['path']):""; ?>&text=<?php print urlencode($node->field_twitter_message['und'][0]['value']);?>','sharer','toolbar=0,status=0,width=626,height=436');return false;}</script>
          <a href="https://twitter.com/share?url=<?php print urlencode($u['path']); ?>&text=<?php  print urlencode($node->field_twitter_message['und'][0]['value']); ?>" onclick="return twt_click_<?php print $k; ?>()" target="_blank">
