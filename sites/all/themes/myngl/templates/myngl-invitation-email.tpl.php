  ...
  <body style="background-color:#e1e1e1; font: 300 14px 'Lato', 'sans-serif';">
    <div style="width:80%; margin-left:auto; margin-right:auto; background-color:#FFF; padding:25px; overflow:auto;">
      ...
      <div style="border-top: 1px solid #999; color:#555; clear:both; padding-top:25px; padding:25px;">
        ...
        <h1 style="font-weight:normal; color: #957f57; font-size: 34px; text-transform: uppercase; letter-spacing: 1px;">YOU'RE INVITED TO THE <?php print $title; ?></h1>
        ...
        <div style="text-align:center; color:#555;">
          <a href="http://166.78.241.22/myngl/<?php print $myngl_id; ?>/rsvp" style="color:#555;text-decoration:none;">
            <img src="http://166.78.241.22/sites/all/themes/myngl/images/rsvp-button.png" /><br />
